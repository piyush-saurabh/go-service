...
import (
	"context"
	_ "embed" // used for reading the file and saving in variable
	"fmt"
...
// [PS] new go feature in 1.17
// [PS] read the file (e.g. sql/schema.sql) from the location in the comment, and save them in variable
var (
