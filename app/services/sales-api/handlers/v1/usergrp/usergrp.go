...
import (
	...
	userCore "github.com/piyush-saurabh/go-service/business/core/user" // [PS] creating alias to prevent name clashing
...
// [PS] handler for /users/:page/:rows
// [PS] Check handlers.go
