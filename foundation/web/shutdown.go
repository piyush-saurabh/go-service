...
// [PS] Go naming convention to have error type ending with Error
...
// a graceful shutdown.
// [PS] Factory function to create and return error
...
// [PS] Helper function to check the type of the error (Assert)
